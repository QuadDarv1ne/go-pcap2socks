...
## Статус проекта (04.04.2026, двадцать пятая волна исправлений)

**Ветка:** `dev` (текущая, синхронизирована с main)

**Последние изменения:**
- ✅ **ДВАДЦАТЬ ПЯТАЯ ВОЛНА** (04.04.2026, исправление executeOnStart и DHCP leak)
- ✅ **ИСПРАВЛЕНО**: executeOnStart сиротские процессы → exec.CommandContext(_gracefulCtx)
- ✅ **ИСПРАВЛЕНО**: DHCP requestCount memory leak → лимит 500 записей + очистка каждую минуту
- ✅ **СБОРКА**: проходит без ошибок (go build)

**Статус веток:**
```
dev:  ✅ 767879e — синхронизирована с origin/dev
main: ✅ c457848 — синхронизирована с origin/main (merge dev)
```
