...
## Статус проекта (04.04.2026, двадцать шестая волна исправлений)

**Ветка:** `dev` (текущая, синхронизирована с main)

**Последние изменения:**
- ✅ **ДВАДЦАТЬ ШЕСТАЯ ВОЛНА** (04.04.2026, ограничение DNS goroutine explosion)
- ✅ **ИСПРАВЛЕНО**: DNS lookupIPUncached goroutine explosion → querySem semaphore (max 20 concurrent)
- ✅ **СБОРКА**: проходит без ошибок (go build)

**Статус веток:**
```
dev:  ✅ 7dd1163 — синхронизирована с origin/dev
main: ✅ 8c2d5bf — синхронизирована с origin/main (merge dev)
```
